...
class Diferente(Instruccion):
    ...
    def interpretar(self, tree, table, generator):
        ...
        return self.Diferenciar(opIzq, opDer, tree, table, generator)

    def getNode(self):
        return super().getNode()

    def Diferenciar(self, opIzq, opDer, tree, table, generator):
        #BOOLEAN
    ...
    def diferenciaCadena(self, newTemp, opIzq, opDer, tree, table, generator):
        ...
        tree.updateConsola(generator.newCallFunc('String_Diferente_armc'))
