...
class Menor(Instruccion):
    ...
    def interpretar(self, tree, table, generator):
        ...
        return self.esMenor(opIzq, opDer, tree, table, generator)

    def getNode(self):
        return super().getNode()

    def esMenor(self, opIzq, opDer, tree, table, generator):
        if self.opIzq.tipo == Tipo.NUMBER and self.opDer.tipo == Tipo.NUMBER:
            ...
            return self.menorCadena(newTemp, valIzq, valDer, tree, table, generator)
    ...
    def menorCadena(self, newTemp, opIzq, opDer, tree, table, generator):
        ...
        tree.updateConsola(generator.newCallFunc('String_Menor_armc'))
