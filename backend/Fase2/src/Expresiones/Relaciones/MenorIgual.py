...
class MenorIgual(Instruccion):
    ...
    def interpretar(self, tree, table, generator):
        ...
        return self.esMenorIgual(opIzq, opDer, tree, table, generator)

    def getNode(self):
        return super().getNode()

    def esMenorIgual(self, opIzq, opDer, tree, table, generator):
        if self.opIzq.tipo == Tipo.NUMBER and self.opDer.tipo == Tipo.NUMBER:
            ...
            return self.menorIgualCadena(newTemp, valIzq, valDer, tree, table, generator)
    ...
    def menorIgualCadena(self, newTemp, opIzq, opDer, tree, table, generator):
        ...
        tree.updateConsola(generator.newCallFunc('String_Menor_Igual_armc'))
